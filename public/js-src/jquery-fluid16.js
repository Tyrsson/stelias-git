...
Toggle : function(){
	var default_hide = {"grid": false };
	$.each(
		["grid", "paragraphs", "blockquote", "list-items", "section-menu", "tables", "forms", "login-forms", "search", "articles", "accordion", "gallery", "user-info", "admin-content", "admin-controls"],
		function() {
