 ...
 *
 * @category   Storefront
 * @package    System_Controller_Helper
 * @copyright  Copyright (c) 2008 Keith Pope (http://www.thepopeisdead.com)
 * @license    http://www.thepopeisdead.com/license.txt     New BSD License
 */
class System_Controller_Action_Helper_RedirectCommon extends Zend_Controller_Action_Helper_Abstract
{
    ...
    public function direct($redirect)
    {
        ...
        throw new System_Exception('Unknown common redirect method');
    }
}