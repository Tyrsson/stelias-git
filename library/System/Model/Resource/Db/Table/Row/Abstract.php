<?php
/**
 * System_Model_Resource_Db_Table_Row_Abstract
 * 
 ...
 */
abstract class System_Model_Resource_Db_Table_Row_Abstract
{
    /**
    ...
    public function setRow(array $config = array())
    {
        ...
        throw new System_Model_Exception('Could not set rowClass in ' . __CLASS__);
    }
