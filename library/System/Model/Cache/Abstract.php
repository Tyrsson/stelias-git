 ...
 */
abstract class System_Model_Cache_Abstract
{
    /**
     ...
     * Constructor 
     * 
     * @param System_Model_Abstract $model
     * @param array|Zend_Config $options 
     */
    public function __construct(System_Model_Abstract $model, $options, $tagged = null)
    {
        $this->_model = $model;
    ...
    */
    ...
    {
        if ('Class' != $frontend) {
            throw new System_Model_Exception('Frontend type must be Class');
        }
    ...
    public function __call($method, $params)
    {
        if (!is_callable(array($this->_model, $method))) {
            throw new System_Model_Exception('Method ' . $method . ' does not exist in class ' . get_class($this->_model) );
        }
        $cache = $this->getCache();
