 ...
 */
abstract class System_Model_Acl_Abstract extends System_Model_Abstract implements System_Model_Acl_Interface, Zend_Acl_Resource_Interface
{
    /**
     * @var Zend_Acl
     */
    ...
    public function setIdentity($identity)
    {
        if (is_array($identity)) {
            ...
            throw new System_Model_Exception('Invalid identity provided');
        }
