 ...
 */
abstract class System_Model_Abstract implements System_Model_Interface
{
    /**
    ...
    */
    ...
    /**
     * @var System_Model_Cache_Abstract
     */
    protected $_cache;
    ...
    */
	 ...
	 *
	 * @param string $name
	 * @return System_Model_Resource_Interface
	 */
     ...
     *
     * @param System_Model_Cache_Abstract $cache
     */
    public function setCache(System_Model_Cache_Abstract $cache)
    {
        $this->_cache = $cache;
    }
     ...
     * @return System_Model_Cache_Abstract
     */
    public function getCached($tagged = null)
    {
        if (null === $this->_cache) {
            $this->_cache = new System_Model_Cache($this, $this->getCacheOptions(), $tagged);
        }
