 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class System_Http_UserAgent_Features_Adapter_Dxbrowscap implements Zend_Http_UserAgent_Features_Adapter
{
    /**
     * Constructor
     *
...
//         }
        ...
        if(!file_exists(APPLICATION_PATH . '/configs/browscap.ini')) {
                        require_once 'Zend/Http/UserAgent/Features/Exception.php';
                        throw new Zend_Http_UserAgent_Features_Exception(sprintf(
                            '%s requires a browscap entry in php.ini pointing to a valid browscap.ini; none present',
                            __CLASS__
    ...
    public static function getFromRequest($request, array $config)
    {
        ...
        $xml = new Zend_Config_Ini(APPLICATION_PATH . '/configs/browscap.xml');
        $browscap = (array) $xml;
