<?php
/** System_Dojo_Form_Element_Dijit */
require_once 'Zend/Dojo/Form/Element/Dijit.php';

/**
 * Editor dijit
 *
 * @uses       System_Dojo_Form_Element_Dijit
 * @category   Zend
 * @package    Zend_Dojo
 ...
 */
class System_Dojo_Form_Element_Editor extends System_Dojo_Form_Element_Dijit
{
    /**
     ...
     *
     * @param  string $plugin
     * @return System_Dojo_Form_Element_Editor
     */
