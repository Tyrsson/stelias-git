...
/** System_Dojo_View_Helper_Dijit */
require_once 'Zend/Dojo/View/Helper/Dijit.php';

/**
 * Abstract class for Dojo Slider dijits
 *
 * @uses       System_Dojo_View_Helper_Dijit
 * @package    Zend_Dojo
 * @subpackage View
 * @copyright  Copyright (c) 2005-2012 Zend Technologies USA Inc. (http://www.zend.com)
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
  */
abstract class System_Dojo_View_Helper_Slider extends System_Dojo_View_Helper_Dijit
{
    /**
     * Dojo module to use
     * @var string
    ...
    public function prepareSlider($id, $value = null, array $params = array(), array $attribs = array())
    {
        ...
        foreach ($this->_requiredParams as $param) {
            if (!array_key_exists($param, $params)) {
                ...
                throw new System_Dojo_View_Exception('prepareSlider() requires minimally the "minimum", "maximum", and "discreteValues" parameters');
            }
        }
        ...
        switch ($this->_sliderType) {
            ...
            default:
                require_once 'Zend/Dojo/View/Exception.php';
                throw new System_Dojo_View_Exception('Invalid slider type; slider must be horizontal or vertical');
        }
