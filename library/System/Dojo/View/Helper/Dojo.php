...
/**
 * System_Dojo_View_Helper_Dojo: Dojo View Helper
 *
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class System_Dojo_View_Helper_Dojo
{
    /**#@+
    ...
    /**
     * @var System_Dojo_View_Helper_Dojo_Container
     */
    ...
    public function __construct()
    {
        ...
        if (!isset($registry[__CLASS__])) {
            ...
            $container = new System_Dojo_View_Helper_Dojo_Container();
     ...
     * @param  array $args
     * @return mixed
     * @throws System_Dojo_View_Exception For invalid method calls
     */
    public function __call($method, $args)
    {
        if (!method_exists($this->_container, $method)) {
            require_once 'Zend/Dojo/View/Exception.php';
            throw new System_Dojo_View_Exception(sprintf('Invalid method "%s" called on dojo view helper', $method));
        }
