 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
  */
abstract class System_Dojo_View_Helper_Dijit extends Zend_View_Helper_HtmlElement
{
    /**
     ...
     * @return System_Dojo_View_Helper_Dijit
     */
    ...
    {
        return System_Dojo_View_Helper_Dojo::useDeclarative();
    }
    ...
    {
        return System_Dojo_View_Helper_Dojo::useProgrammatic();
    }
    ...
    {
        return System_Dojo_View_Helper_Dojo::useProgrammaticNoScript();
    }
