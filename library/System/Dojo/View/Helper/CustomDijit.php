...
/** System_Dojo_View_Helper_DijitContainer */
require_once 'Zend/Dojo/View/Helper/DijitContainer.php';

/**
 * Arbitrary dijit support
 *
 * @uses       System_Dojo_View_Helper_DijitContainer
 * @package    Zend_Dojo
 * @subpackage View
 * @copyright  Copyright (c) 2005-2012 Zend Technologies USA Inc. (http://www.zend.com)
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
  */
class System_Dojo_View_Helper_CustomDijit extends System_Dojo_View_Helper_DijitContainer
{
    /**
     ...
     * @param  array $params
     * @param  array $attribs
     * @return string|System_Dojo_View_Helper_CustomDijit
     */
    public function customDijit($id = null, $value = null, array $params = array(), array $attribs = array())
    {
        ...
        if (!array_key_exists('dojoType', $params)
            ...
            throw new System_Dojo_View_Exception('No dojoType specified; cannot create dijit');
