 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Dxcore_Controller_Action_Helper_ViewRenderer extends Zend_Controller_Action_Helper_Abstract
{
    /**
     ...
     * @var string
     */
    protected $_viewBasePathSpec = ':moduleDir/skins/:skinName';
    ...
    public function getInflector()
    {
        if (null === $this->_inflector) {
            ...
            $this->_inflector->setStaticRuleReference('moduleDir', $this->_moduleDir) // moduleDir must be specified before the less specific 'module'
                             ->setStaticRuleReference('skinName', $this->_skinName)
                 ->addRules(array(
        ...
        //Zend_Debug::dump($this->_inflector, 'getInflector()');
