 ...
 * 
 */
abstract class Gateway_Service_PayPal_Api_AbstractApi
{
    /**
     * The adapter used to send requests.
     * 
     * @var Gateway_Service_PayPal_Adapter_AbstractAdapter
     */
    protected $_adapter;
     ...
     * Constructor.
     * 
     * @param Gateway_Service_PayPal_Adapter_AbstractAdapter $adapter 
     * 
     */
    public function __construct( Gateway_Service_PayPal_Adapter_AbstractAdapter $adapter )
    {
     ...
     * 
     * @return Gateway_Service_PayPal_Response
     */
