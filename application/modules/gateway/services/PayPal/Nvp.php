...
class Gateway_Service_PayPal_Nvp
{
     ...
     *
     * @param Gateway_Service_PayPal_Data_AuthInfo $auth_info
     * @param Zend_Http_Client                  $httpClient
     */
    public function __construct(Gateway_Service_PayPal_Data_AuthInfo $authInfo, array $options = array())
    {
     ...
     * customer.
     *
     * @throws Gateway_Service_PayPal_Exception
     * @param  Gateway_Service_PayPal_Data_CreditCard $creditCard
     * @param  Gateway_Service_PayPal_Data_Address    $address
     * @param  float                               $ammount
     * @param  string                              $remoteAddr
     * @param  string                              $paymentAction
     * @param  array                               $params
     * @return Gateway_Service_PayPal_Nvp_Response
     */
    public function doDirectPayment($amount, 
                                    Gateway_Service_PayPal_Data_CreditCard $creditCard,
                                    Gateway_Service_PayPal_Data_Address $billingAddress, 
                                    Gateway_Service_PayPal_Data_PayerName $payerName,
                                    $paymentAction = Gateway_Service_PayPal::PAYMENT_ACTION_SALE, 
                                    $ipAddress = null, 
                                    array $params = array()
    )
    {
        ...
        if (is_null($ipAddress)) {
            if (! empty($_SERVER['REMOTE_ADDR'])) {
                ...
                throw new Gateway_Service_PayPal_Exception(
     ...
     * @return Gateway_Service_PayPal_Nvp_Response
     */
    public function doExpressCheckoutPayment($token, $payerId, $amount, $paymentAction = Gateway_Service_PayPal::PAYMENT_ACTION_SALE)
    {
    ...
    {
        if (! Gateway_Service_PayPal::validateTransactionId($authorizationId)) {
            // require_once 'Zend/Service/PayPal/Exception.php';
            throw new Gateway_Service_PayPal_Exception('$authorizationId is not a valid PayPal transaction id.  Value given: ' . $authorizationId);
        }
     ...
     * @return Gateway_Service_PayPal_Nvp_Response
     */
    public function doReferenceTransaction($referenceId, $amount, $paymentAction = Gateway_Service_PayPal::PAYMENT_ACTION_SALE,
        $returnFmfDetails = false, $softDescriptor = null, $custom = null, Gateway_Service_PayPal_Data_Address $shipToAddress = null,
        Gateway_Service_PayPal_Data_Address $billingAddress = null, Gateway_Service_PayPal_Data_CreditCard $creditCard = null)
    {
        if (! Gateway_Service_PayPal::validateTransactionId($referenceId)) {
            // require_once 'Zend/Service/PayPal/Exception.php';
            throw new Gateway_Service_PayPal_Exception('$referenceId is not a valid PayPal transaction id.  Value given: ' . $referenceId);
        }
        
        $paymentAction = ucfirst(strtolower((string) $paymentAction));
        if (! ($paymentAction == Gateway_Service_PayPal::PAYMENT_ACTION_SALE || $paymentAction == Gateway_Service_PayPal::PAYMENT_ACTION_AUTHORIZATION)) {
            // require_once 'Zend/Service/PayPal/Exception.php';
            throw new Gateway_Service_PayPal_Exception('Payment Action must be set to either "Sale" or "Authorization"');
        }
            
        $amount = (float) $amount;
        if (! $amount) {
            // require_once 'Zend/Service/PayPal/Exception.php';
            throw new Gateway_Service_PayPal_Exception('Amount must be a floating-point number bigger than zero');
        }
        ...
        if ($billingAddress instanceof Gateway_Service_PayPal_Data_Address) {
            $params = array_merge($params, $billingAddress->toNvp());
        }
        
        if ($creditCard instanceof Gateway_Service_PayPal_Data_CreditCard) {
    ...
    {
        if (! Gateway_Service_PayPal::validateTransactionId($transactionId)) {
            // require_once 'Zend/Service/PayPal/Exception.php';
            throw new Gateway_Service_PayPal_Exception('$transactionId is not a valid PayPal transaction id.  Value given: ' . $transactionId);
        }
        
        if (! in_array($refundType, array(
            Gateway_Service_PayPal::REFUND_TYPE_OTHER, Gateway_Service_PayPal::REFUND_TYPE_FULL, Gateway_Service_PayPal::REFUND_TYPE_PARTIAL)))
        {
            // require_once 'Zend/Service/PayPal/Exception.php';
            throw new Gateway_Service_PayPal_Exception('Refund Type must be set to one of: "Other", "Full", or "Partial"');
        }

        if (! is_null($amount) && (! is_float($amount) || $amount <= 0)) {
            // require_once 'Zend/Service/PayPal/Exception.php';
            throw new Gateway_Service_PayPal_Exception('If passed, amount must be a floating-point number bigger than zero');
        }
        
        if ($refundType == Gateway_Service_PayPal::REFUND_TYPE_PARTIAL && is_null($amount)) {
            // require_once 'Zend/Service/PayPal/Exception.php';
            throw new Gateway_Service_PayPal_Exception('Amount must be set if refund type is ' . Gateway_Service_PayPal::REFUND_TYPE_PARTIAL);
        } elseif ($refundType == Gateway_Service_PayPal::REFUND_TYPE_FULL && ! is_null($amount)) {
            // require_once 'Zend/Service/PayPal/Exception.php';
            throw new Gateway_Service_PayPal_Exception('Amount may not be set if refund type is ' . Gateway_Service_PayPal::REFUND_TYPE_FULL);
        }
     ...
     *
     * @param  array  $receivers    Array of Gateway_Service_PayPal_Data_MassPayReceiver objects
     ...
     * @return Gateway_Service_PayPal_Nvp_Response
     */
    public function massPay(array $receivers, $rcpttype = Gateway_Service_PayPal_Data_MassPayReceiver::RT_EMAIL, $emailSubject = '', $currency = 'USD')
    {
        // Make sure we have more than 0 and less than 256 receivers
        if (empty($receivers) || count($receivers) > 255) {
            // require_once 'Zend/Service/PayPal/Exception.php';
            throw new Gateway_Service_PayPal_Exception("Number of receivers must be between 1 and 255");
        }
            
        // Validate receiver type
        if ($rcpttype == Gateway_Service_PayPal_Data_MassPayReceiver::RT_EMAIL) {
            $idfield = 'L_EMAIL';
        } elseif ($rcpttype == Gateway_Service_PayPal_Data_MassPayReceiver::RT_USERID) {
            $idfield = 'L_RECEIVERID';
        } else {
            // require_once 'Zend/Service/PayPal/Exception.php';
            throw new Gateway_Service_PayPal_Exception("Receiver ID type '$rcpttype' is not valid");
        }

        // Validate currency code
        if (! Gateway_Service_PayPal::validateCurrencyCode($currency)) {
            // require_once 'Zend/Service/PayPal/Exception.php';
            throw new Gateway_Service_PayPal_Exception("Currency code '$currency' is not valid");
        }
        ...
        if ($emailSubject) {
            if (strlen($emailSubject) > 255) {
                // require_once 'Zend/Service/PayPal/Exception.php';
                throw new Gateway_Service_PayPal_Exception("Email Subject must be up to 255 single-byte characters");
            }
        ...
        $c = 0;
        foreach ($receivers as $rcpt) { /* @var $rcpt Gateway_Service_PayPal_Data_MassPayReceiver */
            if (! $rcpt->getReceiverType() == $rcpttype) {
                // require_once 'Zend/Service/PayPal/Exception.php';
                throw new Gateway_Service_PayPal_Exception("All receiver ID types must be '$rcpttype', '{$rcpt->getReceiverId()}' is not"); 
            }
    ...
    public function getTransactionDetails($transactionId)
    {
        if (! Gateway_Service_PayPal::validateTransactionId($transactionId)) {
            // require_once 'Zend/Service/PayPal/Exception.php';
            throw new Gateway_Service_PayPal_Exception("'$transactionId' is not a valid PayPal transaction ID");
        }
...
//     }
    ...
    protected function _doMethodCall($methodName, array $aParams)
    {
        ...
        return new Gateway_Service_PayPal_Nvp_Response($this->_lastResponse);
    }
} 
