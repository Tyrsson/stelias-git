...
class Gateway_Service_PayPal_Data_MassPayReceiver
{
    /**
     ...
     * 
     * @param  string $id
     * @return Gateway_Service_PayPal_Data_MassPayReceiver
     */
     ...
     *
     * @throws Gateway_Service_PayPal_Data_Exception
     * @param float $amount
     * @return Gateway_Service_PayPal_Data_MassPayReceiver
     */
    public function setAmount( $amount )
    {
        if ( floatval( $amount ) <= 0 ) {
             ...
             throw new Gateway_Service_PayPal_Data_Exception(
